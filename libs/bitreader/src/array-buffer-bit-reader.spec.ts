import { ArrayBufferBitReader } from './array-buffer-bit-reader';
...
describe('ArrayBufferBitReader', () => {
  describe('peek', () => {
    describe('with a buffer with all zeroes', () => {
      ...
      it.each<[number, number]>(
        ...
        const br = new ArrayBufferBitReader(bytes);
    ...
    it('should peek different lengths into a byte', () => {
      ...
      const br = new ArrayBufferBitReader(Uint8Array.from(bytes).buffer);
  ...
  describe('skip', () => {
    it.each<[number, number[]]>([
      ...
      const br = new ArrayBufferBitReader(Uint8Array.from(data).buffer);
      br.skip(n);
  ...
  describe('seek', () => {
    it('should move around', () => {
      ...
      const br = new ArrayBufferBitReader(data.buffer);
  ...
  describe('alignment', () => {
    it('should know when its aligned', () => {
      const br = new ArrayBufferBitReader(new ArrayBuffer(8));
    ...
    it('align itself to the next byte', () => {
      const br = new ArrayBufferBitReader(
        Uint8Array.from([
